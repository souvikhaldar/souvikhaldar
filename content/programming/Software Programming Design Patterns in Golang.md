...
3. Abstracted, so not everyone needs to dig deep into the code in order to be able to able to use it.  
many more!
...
## Observer Pattern
Sometimes, we need to react to change of state of objects in the code. We want to observe the change in the state of the object and whenever it changes, we want certain reaction to it. 
...
```
## Conclusion
Hope you've got an idea of some of the popular design patterns that you can use to improve the quality of overall codebase. This is definitely not the exhaustive list. Please feel free provide feedbacks to me on any medium of choice, links to which are provided in the homepage of my website. Happy coding! 
